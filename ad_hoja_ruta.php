...
header("Location: gestionar_hoja_ruta.php?id_usuario=".$id_usuario."&nombre_usuario=".$nombre_usuario."&nombre_rol=".$nombre_rol."&numero_pedido=".$numero_pedido."&opcion=Buscar");
mysql_free_result($result);
break;
...
header("Location: gestionar_hoja_ruta.php?id_usuario=".$id_usuario."&nombre_usuario=".$nombre_usuario."&nombre_rol=".$nombre_rol."&numero_pedido=".$numero_pedido."&opcion=Guardar Ruta&mensaje=Ruta guardada correctamente");
}
else
{
header("Location: gestionar_hoja_ruta.php?id_usuario=".$id_usuario."&nombre_usuario=".$nombre_usuario."&nombre_rol=".$nombre_rol."&numero_pedido=".$numero_pedido."&opcion=Guardar Ruta&mensaje=Eliga el orden de la ruta correctamente");
}
