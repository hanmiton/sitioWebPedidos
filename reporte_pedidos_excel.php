...
<h4>Transporte de Carga Pesada LE & MA</h4>
  Número de Pedido: <?php echo $numero_pedido?>
  <br>
  Fecha de Pedido: <?php echo $fecha_pedido?>
  <br>
  Estado de Pedido: <?php echo estado_pedido($estado_pedido)?>
  <br>
  Pedido Asignado: <?php echo asignado_pedido($asignado_pedido)?>
<table >
											<thead>
												<tr>
