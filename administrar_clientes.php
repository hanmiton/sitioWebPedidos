					  ...
					  <div class="page-header">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="POST"  action="ad_clientes.php">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="text_cedula"> Id. Cliente </label>
										
										<div class="col-sm-9">
											<input type="text" name="text_cedula"  placeholder="Id. Cliente" class="col-xs-10 col-sm-5"  value ="<?php echo $id_cliente ?>"/>
											<button class="btn btn-info" name="bt_opcion" value="Buscar" type="submit">
												<i class="fa fa-search bigger-110"></i>
												Buscar
											</button>
											<i class="menu-icon fa fa-list-alt orange"></i>
											<a href="<?php echo "mostrar_clientes.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol"; ?>">Mostrar Clientes </a>
									  </div>
									</div>
									
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="text_nombres">Nombre </label>

										<div class="col-sm-9">
										  <input type="text"  name="text_nombre"  class="form-control"  placeholder="Nombre" value ="<?php echo $nombre_cliente?>" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="text_password">Dirección</label>

								  <div class="col-sm-9">
											<input name="text_direccion" type="text" class="col-xs-10 col-sm-5" id="text_direccion" value ="<?php echo $direccion_cliente?>" placeholder="Dirección" />
									  </div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="text_email">Teléfono</label>

										<div class="col-sm-9">
											<input type="text" name="text_telefono" placeholder="Teléfono" class="col-xs-10 col-sm-5" value ="<?php echo $telefono_cliente?>" />
										</div>
									</div>
									...
									<label class="col-sm-3 control-label no-padding-right" for="text_ciudad">Ciudad</label>
 									<div class="col-sm-4"> 
															<select class="form-control" id="text_ciudad" name="text_ciudad">
								...
								$query = "SELECT id_ciudad, nombre_ciudad FROM ciudad WHERE id_ciudad='".$id_ciudad."'";
                				...
                				<?php $query = "SELECT id_ciudad, nombre_ciudad FROM ciudad AS nombre_ciudad";
										mysql_query("SET NAMES 'UTF8'");
									$result = mysql_query($query) or die('Consulta fallida: ' . mysql_error());
									while ($line= mysql_fetch_array($result)) 
									{
									?>
               					 <option value="<?php echo $line['id_ciudad'];?>"> <?php echo $line['nombre_ciudad'];?></option>
                				<?php
									 }
									 mysql_free_result($result);
									?>
