					  ...
					  <div class="page-header">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="POST"  action="ad_camiones.php">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="text_cedula">Placa</label>

										<div class="col-sm-9">
											<input name="text_placa" type="text" class="col-xs-10 col-sm-5" id="text_placa"  value ="<?php echo $id_camion ?>"  placeholder="Placa"/>
											<button class="btn btn-info" name="bt_opcion" value="Buscar" type="submit">
												<i class="fa fa-search bigger-110"></i>
												Buscar
											</button>
											<i class="menu-icon fa fa-list-alt orange"></i>
											<a href="<?php echo "mostrar_camiones.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol"; ?>">Mostrar Camiones</a>
									  </div>
									</div>
									
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="text_nombres">Marca</label>

										<div class="col-sm-9">
										  <input  name="text_marca" type="text"  class="form-control" id="text_marca" value ="<?php echo $marca_camion ?>"  placeholder="Marca" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="text_password">Modelo</label>

								  <div class="col-sm-9">
											<input name="text_modelo" type="text" class="col-xs-10 col-sm-5" id="text_modelo" value ="<?php echo $modelo_camion?>" placeholder="Modelo"  />
									  </div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="text_email">Descripción</label>
										<div class="col-sm-9">
											<input name="text_descripcion" type="text" class="col-xs-10 col-sm-5" id="text_descripcion" value ="<?php echo $descripcion_camion?>" placeholder="Descripción" />
										</div>
								  </div>
									...
									<label class="col-sm-3 control-label no-padding-right" for="text_rol">Disponible</label>
 									<div class="col-sm-4"> 
															<input name="text_disponible" type="text"  value ="<?php echo $disponible_camion?>" size="5" maxlength="5" readonly="readonly"/>
									  </div>
