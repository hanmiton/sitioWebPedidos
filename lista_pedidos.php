...
<script type="text/javascript">
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="POST"  action="ad_reportes_pedidos.php">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input name="text_numero" type="text" class="col-xs-10 col-sm-2" id="text_numero"  value ="<?php echo $numero_pedido ?>"  placeholder="Número Pedido"/>
											
											<button class="btn btn-info" name="bt_opcion" value="Consultar"  type="submit">
												<i class="menu-icon fa fa-file-o bigger-120"></i>Consultar</button>
											
											<label >Fecha </label>
												<input type="text" name="text_fecha" id="text_fecha" value ="<?php echo $fecha_pedido ?>"  placeholder="Fecha"/> <img src="ima/calendario.png" width="16" height="16" border="0" title="Fecha Inicial" id="lanzador" onClick="calendario()" />
			 ...
			 Exportar: 
			 <a href="<?php echo "reporte_pedidos_excel.php?t=excel&id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol&numero_pedido=$numero_pedido&fecha_pedido=$fecha_pedido&estado_pedido=$estado_pedido"; ?>">   <i class='fa fa-file-excel-o bigger-110 green'></i>   </a>
			 
<a href="<?php echo "reporte_pedidos_pdf.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol&numero_pedido=$numero_pedido&fecha_pedido=$fecha_pedido&estado_pedido=$estado_pedido"; ?>"> 
...
?>
												...
												<tr>
													...
													<td> <?php echo $line['fecha_pedido']; ?></td>
													<td ><?php echo $line['estado_pedido']; ?></td>
		...
		$cantidad=$cantidad+1;
		 ...
		 <tr>
													...
													<td align="center">  <?php $estado_pedido=$line['estado_pedido']; echo $line['estado_pedido'] ?></td>
											  </tr>
