...
if (!empty($_REQUEST['opcion']))
{
 ...
 if ($opcion=="Elaborar")
 {
	...
	$id_ayudante= $_REQUEST['id_ayudante'];
					  ...
					  <div class="page-header">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="POST"  action="ad_viajes.php">
								  <div class="row">
								<div class="col-xs-12">
								...
								<table id="simple-table" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													...
													<th>Pedido</th>
													<th>Conductor</th>
													<th class="hidden-480">Camión</th>

													<th>Ayudante</th>
													<th class="hidden-480">Fecha Salida</th>

													<th class="hidden-480">Fecha Llegada</th>
													<th class="hidden-480">Elaborar
Viaje													
            ...
            <input name="nombre_rol" type="hidden" id="nombre_rol" value="<?php echo $nombre_rol?>"/></td>													</th>
												</tr>
											</thead>
								...
								<tr>
													<td  >
												 <select name="text_pedido"  id="text_pedido"> 
								  ...
								  <?php
									...
									<select name="text_chofer"  id="text_chofer" >
									...
									?>
													...
													<td class="hidden-480" >
													<select name="text_camion" id="text_camion">
								...
								<select name="text_ayudante"  id="text_ayudante">
								...
								<td class="hidden-480">
								<input name="text_fechas" type="text" id="text_fechas" value ="<?php echo $fecha_salida ?>" size="8"  readonly="readonly"/>
								<img src="ima/calendario.png" width="16" height="16" border="0" title="Fecha Inicial" id="lanzador" onClick="calendario()" /></span>											</td>
									...
									<td class="hidden-480">
									 ...
									 <input name="text_fechal" type="text" id="text_fechal" value ="<?php echo $fecha_llegada ?>" size="8"  readonly="readonly"/>
              <img src="ima/calendario.png" width="16" height="16" border="0" title="Fecha Inicial" id="lanzador1" onClick="calendario1()" /></span>									</td>	
									<th class="hidden-480">
								  
								  <input name="bt_opcion" type="submit" id="bt_opcion" value="Elaborar">
								  </th>
									</tr>
...
?>
		  ...
		  ?>           </td>
            <td align="center"><?php echo $fecha_salida; ?></td>
            <td align="center"><?php echo $fecha_llegada; ?></td>
            <td><a href="<?php echo "ad_viajes.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol&text_pedido=$numero_pedido&text_chofer=$id_chofer&text_camion=$id_camion&text_ayudante=$id_ayudante&text_fechas=$fecha_salida&text_fechal=$fecha_llegada&bt_opcion=Eliminar"; ?>">
			<span class="green">
						  <i class="ace-icon fa fa-trash-o bigger-120"></i>						  </span>	</a></td>
          </tr>
								...
								<table id="simple-table" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													...
													<th class="hidden-480">Fecha Llegada</th>
													<th class="hidden-480">Cerrar Viaje </th>
												</tr>
											</thead>
 ...
 <?php $query="SELECT viaje.numero_pedido, chofer.id_chofer,nombre_chofer, camion.id_camion,marca_camion, ayudante.id_ayudante,nombre_ayudante, fecha_salida,fecha_llegada FROM viaje INNER JOIN chofer ON chofer.id_chofer=viaje.id_chofer INNER JOIN camion ON camion.id_camion=viaje.id_camion INNER JOIN ayudante ON ayudante.id_ayudante=viaje.id_ayudante WHERE  viaje.estado_viaje='0' ";
...
?>
		...
		$id_chofer=$line['id_chofer'];	
		  ...
		  ?>            </td>
		    ...
		    echo $line['nombre_ayudante'];
		  ?>           </td>
            <td align="center"><?php echo $line['fecha_salida'];?></td>
            <td align="center"><?php echo $line['fecha_llegada'];?></td>
            <td><a href="<?php echo "ad_viajes.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol&text_pedido=$numero_pedido&text_chofer=$id_chofer&text_camion=$id_camion&text_ayudante=$id_ayudante&text_fechas=$fecha_salida&text_fechal=$fecha_llegada&bt_opcion=Cerrar"; ?>">Cerrar</a>
		</td>
          </tr>
