				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Pedidos Entregados</li>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="POST"  action="ad_reportes_pedidos.php">
									   ...
									   <div class="col-xs-12">
										...
										<input name="text_numero" type="text"  id="text_numero"  value ="<?php echo $numero_pedido ?>"  />
										
										<button class="btn btn-info" name="bt_opcion" value="Buscar2"  type="submit">
												<i class="fa fa-search bigger-110"></i>Buscar</button>
											</div>
								...
								<table id="simple-table" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													...
													<th>Pedido Asignado Conductor</th>
<th>Ver Pedido</th>
												</tr>
											</thead>
		 ...
		 $query = "SELECT numero_pedido,fecha_pedido,estado_pedido,asignado_pedido FROM pedido INNER JOIN proveedor ON proveedor.id_proveedor=pedido.id_proveedor INNER JOIN cliente ON cliente.id_cliente=pedido.id_cliente INNER JOIN producto ON producto.id_producto=pedido.id_producto INNER JOIN ciudad ON cliente.id_ciudad=ciudad.id_ciudad WHERE numero_pedido LIKE '".$numero_pedido."%' and estado_pedido=1 GROUP BY numero_pedido ORDER BY numero_pedido  ";
...
?>
												...
												<tr>
													...
													<td> <?php $numero_pedido=$line['numero_pedido']; echo $line['numero_pedido']; ?>   </td>
													<td> <?php $fecha_pedido=$line['fecha_pedido']; echo $line['fecha_pedido']; ?></td>
													<td ><?php $estado_pedido=$line['estado_pedido']; echo estado_pedido($line['estado_pedido']); ?></td>
													<td ><?php $asignado_pedido=$line['asignado_pedido']; echo asignado_pedido($line['asignado_pedido']); ?></td>

													<td > <a href="<?php echo "reporte_pedidos_entregados1.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol&numero_pedido=$numero_pedido&fecha_pedido=$fecha_pedido&estado_pedido=$estado_pedido&asignado_pedido=$asignado_pedido"; ?>"> <i class="ace-icon fa fa-search-plus bigger-130"></i>		</a>	</td>
												</tr>
		 <?php 
