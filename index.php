				...
				<div class="navbar-header pull-left">
					<a href="#" class="navbar-brand">
						<small>
							...
							<img src="imagenes/logo_pedidos.png" width="1240" height="120" >						</small>					</a>				</div>
					  ...
					  <div class="page-header">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="POST" action="perfil.php">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="text_cedula"> Cédula </label>

										<div class="col-sm-9">
											<input type="text" id="text_cedula" name="text_cedula" placeholder="Cédula" class="col-xs-10 col-sm-5" />
									  </div>
									</div>
								  ...
								  <div class="col-sm-9">
											<input type="password" id="text_password" name="text_password" placeholder="Password" class="col-xs-10 col-sm-5" />
									  </div>
									</div>
