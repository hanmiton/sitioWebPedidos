				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="administrar_clientes.php<?php echo "?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol"; ?>">Clientes</a>
							</li>
							...
							<div class="col-xs-12">
								...
								<table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>
											  ...
											  <?php
 $query = "SELECT id_cliente,nombre_cliente,direccion_cliente,telefono_cliente,ciudad.id_ciudad,nombre_ciudad  FROM cliente INNER JOIN ciudad ON cliente.id_ciudad=ciudad.id_ciudad";
...
?>
												...
												<tr>
													...
													<td>
														<a href="#">  <?php  $id_cliente=$line['id_cliente'];echo $line['id_cliente'];?></a>													</td>
													<td> <span class="Estilo16"><?php echo $line['nombre_cliente']?></td>
													<td class="hidden-480"><?php echo $line['direccion_cliente']?></td>
													<td><?php echo $line['telefono_cliente']?></td>

													<td class="hidden-480">
														<?php echo $line['nombre_ciudad']?>												</td>
													...
													<td>
																		...
																		<a href="<?php echo "ad_clientes.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol&text_cedula=$id_cliente&bt_opcion=Buscar"; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																			<span class="green">
