...
?>
    ...
    <td width="1097" align="center" valign="top"><table width="1092" height="57" border="0" cellspacing="0" background="imagenes/tabla.jpg">
      <tr>
        <td width="273">&nbsp;</td>
        <td width="815"><img src="imagenes/m_gestionar_pedidos1.png" width="888" height="30" /></td>
      </tr>
    </table>
      <form id="form1" name="form1" method="get" action="ad_pedidos.php">
        ...
        <tr>
          ...
          <td colspan="2"><span class="Estilo5">
            <input name="text_asignado" type="text" id="text_asignado" value ="<?php echo $asignado_pedido; ?>" size="5" maxlength="10" readonly/>
          </span></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td height="21" align="center"><span class="Estilo15">Proveedor</span></td>
...
?>
          ...
          <td><span class="Estilo5">
            <input name="text_estado" type="text" id="text_estado" value ="<?php echo $estado_pedido; ?>" size="5" maxlength="10" readonly />
          </span></td>
          <td><span class="Estilo5">
...
?>  
        ...
        <tr>
          ...
          <td height="21" class="Estilo12"><span class="Estilo12"><span class="Estilo5 Estilo18 Estilo1">
            <?php $id_proveedor=$line['id_proveedor']; echo $line['nombre_proveedor'] ?>
          </span></span></td>
          <td class="Estilo12"><span class="Estilo12"><span class="Estilo5 Estilo18 Estilo1">
            <?php $id_producto=$line['id_producto']; echo $line['nombre_producto'] ?>
          </span></span></td>
          <td colspan="2" class="Estilo12"><span class="Estilo12"><span class="Estilo5 Estilo18 Estilo1">
            <?php $id_cliente=$line['id_cliente']; echo $line['nombre_ciudad'] ."/". $line['nombre_cliente']?>
          </span></span></td>
          <td align="right" class="Estilo12"><span class="Estilo12"><span class="Estilo5 Estilo18 Estilo1">
            <?php $cantidad_pedido=$line['cantidad_pedido']; echo $line['cantidad_pedido'] ?>
          </span></span></td>
          <td align="center" class="Estilo12"><span class="Estilo12"><span class="Estilo1">
