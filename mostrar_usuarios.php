...
$nombre_rol1=$_REQUEST['nombre_rol'];
}
				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="administrar_usuarios.php<?php echo "?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol"; ?>">Usuarios</a>
							</li>
							...
							<div class="col-xs-12">
								...
								<table id="simple-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>
											  ...
											  <?php
 $query = "SELECT usuario.id_usuario,usuario.nombre_usuario,usuario.password_usuario,usuario.email_usuario,usuario.id_rol,rol.nombre_rol FROM usuario INNER JOIN rol ON usuario.id_rol=rol.id_rol";
...
?>
												...
												<tr>
													...
													<td>
														<a href="#">  <?php  $id_usu=$line['id_usuario'];echo $line['id_usuario'];?></a>													</td>
													<td> <span class="Estilo16"><?php echo $line['nombre_usuario']?></td>
													<td class="hidden-480"><?php echo $line['password_usuario']?></td>
													<td><?php echo $line['email_usuario']?></td>

													<td class="hidden-480">
														<?php echo $line['nombre_rol']?>												</td>
													...
													<td>
																		...
																		<a href="<?php echo "ad_usuarios.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol&text_cedula=$id_usu&bt_opcion=Buscar"; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																			<span class="green">
