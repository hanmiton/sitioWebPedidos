...
<script type="text/javascript">
					  ...
					  <div class="page-header">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="POST"  action="ad_pedidos.php">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="text_cedula">Número de Pedido </label>

								  <div class="col-sm-9">
											<input name="text_numero" type="text" class="col-xs-10 col-sm-2" id="text_numero"  value ="<?php echo $numero_pedido ?>" readonly="readonly" placeholder="Número de Pedido"/>
											<label >Fecha </label>
											  <input type="text" name="text_fecha" id="text_fecha" value ="<?php echo $fecha_pedido ?>"  placeholder="Fecha"/>
									    <img src="ima/calendario.png" width="16" height="16" border="0" title="Fecha Inicial" id="lanzador" onClick="calendario()" />
											  											

											  
												<input type="hidden"  name="text_asignado" id="text_asignado" value ="<?php echo $asignado_pedido ?> "  size="5" maxlength="5" 	readonly="readonly"/>
																															
		                          <span class="Estilo1"></div>				   
			  ...
			  <table id="simple-table1" class="table table-striped table-bordered table-hover">
									...
									<select name="text_proveedor" class="form-control" id="text_proveedor">
                				...
                				<?php
									...
									?>
													...
													<select name="text_producto" class="form-control" id="text_producto">
								...
								?>
													...
													<td class="hidden-480">
														...
														<select name="text_cliente" class="form-control" id="text_cliente">
							...
							?>
													...
													<td>
													<input name="text_cantidad" type="text"  value ="<?php echo $cantidad_pedido?>" size="10" maxlength="10" />
																									</td>

														<input name="text_estado" type="hidden"  value ="<?php echo $estado_pedido?>" size="5" maxlength="5" readonly="readonly" />
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											<button class="btn btn-info" name="bt_opcion" value="Nuevo"  type="submit" <?php echo $disablednuevo; ?>>
												<i class="menu-icon fa fa-file-o bigger-120"></i>
												Nuevo
											</button>

											<button class="btn btn-info" name="bt_opcion" value="Registrar"   <?php echo $disabledbotones; ?> type="submit">
												<strong><i class="ace-icon fa fa-check bigger-120"></i></strong>
												Registrar
											</button>


											<button class="btn" type="submit" name="bt_opcion" value="Aceptar" <?php echo $disabledbotones; ?> >
...
?>	
		...
		$cantidad=$cantidad+1;
		 ...
		 <tr>
													...
													<td class="hidden-480"><?php $id_cliente=$line['id_cliente']; echo $line['nombre_ciudad'] ."/". $line['nombre_cliente']?></td>

													<td>  <?php $cantidad_pedido=$line['cantidad_pedido']; echo $line['cantidad_pedido']; $estado_pedido=$line['estado_pedido']; ?></td>
													  

													<td class="hidden-480"><a href="<?php echo "ad_pedidos.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol&text_numero=$numero_pedido&text_proveedor=$id_proveedor&text_producto=$id_producto&text_cliente=$id_cliente&text_cantidad=$cantidad_pedido&text_fecha=$fecha_pedido&text_asignado=$asignado_pedido&text_estado=$estado_pedido&bt_opcion=Eliminar"; ?>" class="tooltip-success" data-rel="tooltip" title="Delete">
																			<span class="green">
