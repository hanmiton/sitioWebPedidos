				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Todos los Pedidos</li>
...
<th>Ver Pedido</th>
		 ...
		 $query = "SELECT numero_pedido,fecha_pedido,estado_pedido,asignado_pedido FROM pedido INNER JOIN proveedor ON proveedor.id_proveedor=pedido.id_proveedor INNER JOIN cliente ON cliente.id_cliente=pedido.id_cliente INNER JOIN producto ON producto.id_producto=pedido.id_producto INNER JOIN ciudad ON cliente.id_ciudad=ciudad.id_ciudad WHERE numero_pedido LIKE '".$numero_pedido."%' GROUP BY numero_pedido ORDER BY numero_pedido  ";
...
?>
												...
												<tr>
													...
													<td > <a href="<?php echo "reporte_pedidos1.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol&numero_pedido=$numero_pedido&fecha_pedido=$fecha_pedido&estado_pedido=$estado_pedido&asignado_pedido=$asignado_pedido"; ?>"> <i class="ace-icon fa fa-search-plus bigger-130"></i>		</a>	</td>
												</tr>
		 <?php 
