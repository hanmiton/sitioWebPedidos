...
<script type="text/javascript">
				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="administrar_conductores.php<?php echo "?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol"; ?>">Conductores</a>
							</li>
							
							<li class="active">Mostrar Conductores</li>
		  ...
		  $query = "SELECT id_chofer,nombre_chofer,direccion_chofer,telefono_chofer,disponible_chofer  FROM chofer ";
...
while ($line= mysql_fetch_array($result)) {
 ?>
												...
												<tr>
													...
													<td>
														<a href="#">   <?php  $id_chofer=$line['id_chofer'];echo $line['id_chofer'];?></a>													</td>
													<td> <?php echo $line['nombre_chofer']?></td>
													<td class="hidden-480"><?php echo $line['direccion_chofer']?></td>
													<td><?php echo $line['telefono_chofer']?></td>

													<td class="hidden-480">
														<?php echo $line['disponible_chofer']?>											</td>

													<td>
													<a href="<?php echo "ad_conductores.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol&text_cedula=$id_chofer&bt_opcion=Buscar"; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																			<span class="green">
