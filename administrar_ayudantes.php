					  ...
					  <div class="page-header">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="POST"  action="ad_ayudantes.php">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="text_cedula"> Cédula </label>

										<div class="col-sm-9">
											<input type="text" name="text_cedula"  placeholder="Cédula" class="col-xs-10 col-sm-5"  value ="<?php echo $id_ayudante ?>"/>
											<button class="btn btn-info" name="bt_opcion" value="Buscar" type="submit">
												<i class="fa fa-search bigger-110"></i>
												Buscar
											</button>
											<i class="menu-icon fa fa-list-alt orange"></i>
											<a href="<?php echo "mostrar_ayudantes.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol"; ?>">Mostrar Ayudantes</a>
									  </div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										  <input type="text"  name="text_nombre"  class="form-control"  placeholder="Nombres" value ="<?php echo $nombre_ayudante ?>" />
										</div>
									</div>
								  ...
								  <div class="col-sm-9">
											<input type="text" name="text_direccion" placeholder="Dirección" class="col-xs-10 col-sm-5" value ="<?php echo $direccion_ayudante?>"  />
									  </div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="text_telefono" placeholder="Teléfono" class="col-xs-10 col-sm-5" value ="<?php echo $telefono_ayudante?>" />
										</div>
									</div>
									...
									<label class="col-sm-3 control-label no-padding-right" for="text_rol">Disponible</label>
 									<div class="col-sm-4"> 
															<input name="text_disponible" type="text"  value ="<?php echo $disponible_ayudante?>" size="5" maxlength="5" readonly="readonly"/>
														</div>
