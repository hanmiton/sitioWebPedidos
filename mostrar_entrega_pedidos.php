				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Mostrar Pedidos Entregados</li>
							...
							<div class="col-xs-12">
								...
								<div class="col-xs-12">
								  <div class="col-xs-12">
										...
										<label >Conductor: <?php echo $nombre_chofer ?> 
								...
								<table id="simple-table" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													...
													<th class="hidden-480">Ver Pedido </th>
												</tr>
											</thead>
