...
$password_usu=$_GET['password_usu'];
$email_usu=$_GET['email_usu'];
$rol_usu=$_GET['rol_usu'];
$nombre_rol_usu=$_GET['nombre_rol_usu'];
}
...
?>
    ...
    <td width="1090" align="center" valign="top"><table width="1092" height="57" border="0" cellspacing="0" background="imagenes/tabla.jpg">
      <tr>
        <td width="273">&nbsp;</td>
        <td width="815"><img src="imagenes/m_gestionar_usuarios.png" width="888" height="30" /></td>
      </tr>
    </table>
      <form id="form1" name="form1" method="get" action="ad_usuarios.php">
        <br />
      <table width="590" height="178" border="1" cellspacing="0" bordercolor="#EAEAEA" background="imagenes/fondotabla4.png">
        ...
        <tr>
          <td width="74"><span class="Estilo15">C&eacute;dula</span></td>
          <td colspan="2"><label>
            <input name="text_cedula" type="text" id="text_cedula" value ="<?php echo $id_usu ?>" />
            <span class="Estilo5">*</span></label></td>
          <td colspan="3"><input name="bt_opcion" type="submit" id="bt_opcion" value="Buscar" /></td>
          </tr>
        <tr>
          <td><span class="Estilo15">Nombres</span></td>
          <td colspan="5"><input name="text_nombre" type="text" id="text_nombre" size="50" maxlength="50" value ="<?php echo $nombre_usu ?>" />
            <span class="Estilo5">*</span></td>
          </tr>
        <tr>
          <td><span class="Estilo15">Password</span></td>
          <td colspan="5"><input name="text_password" type="text" id="text_password" value ="<?php echo $password_usu?>"/>
              <span class="Estilo5"> *</span></td>
          </tr>
        <tr>
          <td><span class="Estilo15">Email</span></td>
          <td colspan="5"><input name="text_email" type="text" id="text_email" value ="<?php echo $email_usu?>" size="40" maxlength="40"/>
            <span class="Estilo5"> *</span></td>
          </tr>
        <tr>
          <td><span class="Estilo15">Rol </span></td>
          <td colspan="5"><label>
            <select name="text_rol" id="text_rol">
              <option value="<?php echo $rol_usu?>"><?php echo $nombre_rol_usu?></option>
              <option value="1">Administrador</option>
              <option value="2">Técnico</option>
              <option value="3">Conductor</option>
              </select>
            <span class="Estilo5"> *</span></label>
        ...
        <tr>
          ...
          <td width="68"><span class="Estilo1 Estilo12 Estilo4"><strong><a href="<?php echo "mostrar_usuarios.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol"; ?>">Mostrar</a></strong></span></td>
        </tr>
      </table>
      <label></label>
      <p>&nbsp;</p>
