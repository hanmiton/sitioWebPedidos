				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
								...
								<li>
								<a href="entregar_pedidos.php<?php echo "?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol"; ?>">Entregar Pedidos</a>							</li>
								
								
							<li class="active">Realizar Entrega</li>
					  ...
					  <div class="page-header">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal"  enctype="multipart/form-data" role="form" method="POST"  action="ad_entrega.php">
								  <div class="row">
								<div class="col-xs-12">
								...
								<table id="simple-table" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
												  ...
												  <th width="12%">Pedido:
												      ...
												      <input  name="numero_pedido" type="hidden"   id="numero_pedido" value ="<?php echo $numero_pedido; ?>" />
											...
											<tr>
											 ...
											 <td> Conductor: <?php echo $nombre_chofer; ?> <input name="id_chofer" type="hidden" id="id_chofer" value="<?php echo $id_chofer ?>"/> </td></tr>
											 <tr>
											<td>Cliente:  <?php echo $nombre_cliente; ?>  
											    <input name="id_cliente" type="hidden" id="id_cliente" value="<?php echo $id_cliente ?>"/>                                                <input name="nombre_cliente" type="hidden" id="nombre_cliente" value="<?php echo $nombre_cliente; ?>"/>  </td>
											
											</tr>
											 <tr>
											<td> 
											Ciudad: 
                                                  <?php echo $nombre_ciudad; ?>
                                                  <input name="id_ciudad" type="hidden" id="id_ciudad" value="<?php echo $id_ciudad ?>"/>
												  <input name="nombre_ciudad" type="hidden" id="nombre_ciudad" value="<?php echo $nombre_ciudad; ?>"/>
											 </td>
...
?>
          <tr>
		   ...
		   <td >
              <?php $id_ciudad=$line['id_ciudad']; $nombre_ciudad=$line['nombre_cliente']; echo $line['nombre_proveedor'] ?>			  </td>
            <td height="26">
             <?php  $id_producto=$line['id_producto']; echo $line['nombre_producto'] ?>           </td>
            <td>
                <?php  $cantidad_pedido=$line['cantidad_pedido']; echo $line['cantidad_pedido'] ?>      </td>
			  
			  <td><?php  $estado_pedido=$line['estado_pedido']; echo estado_pedido($line['estado_pedido']); $acta1=$line['acta'];?></td>
									...
									<div class="row">
										<div class="col-sm-4">
											...
											<div class="widget-box">
												<div class="widget-header">
													<h4 class="widget-title">Selecione el Acta de Entrega</h4>
												...
												<div class="widget-body">
													<div class="widget-main">
														<div class="form-group">
															<div class="col-xs-12">
															Entrega: 
																<input name="entrega" type="checkbox" id="entrega" value="<?php echo "1"; ?>"  <?php echo $entregado;?>/>
															</div>
														</div>
														...
														<div class="form-group">
															<div class="col-xs-12">
																...
																<input name="acta" type="file" id="acta" size="5" maxlength="5" />
															</div>
														</div>
										...
										<div class="col-sm-4">
											...
											<div class="widget-box">
												...
												<div class="widget-body">
												<img onClick="javascript:this.width=450;this.height=338" onDblClick="javascript:this.width=100;this.height=100" src="data:image/jpg; base64,<?php echo base64_encode($acta1); ?>" width="100" height="100"/> 	
