				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Pedidos Elaborados</li>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="POST"  action="ad_reportes_pedidos.php">
									   ...
									   <div class="col-xs-12">
										...
										<button class="btn btn-info" name="bt_opcion" value="Buscar1"  type="submit">
...
<th>Ver Pedido</th>
		 ...
		 $query = "SELECT numero_pedido,fecha_pedido,estado_pedido,asignado_pedido FROM pedido INNER JOIN proveedor ON proveedor.id_proveedor=pedido.id_proveedor INNER JOIN cliente ON cliente.id_cliente=pedido.id_cliente INNER JOIN producto ON producto.id_producto=pedido.id_producto INNER JOIN ciudad ON cliente.id_ciudad=ciudad.id_ciudad WHERE numero_pedido LIKE '".$numero_pedido."%' and estado_pedido=0 GROUP BY numero_pedido ORDER BY numero_pedido  ";
...
?>
												...
												<tr>
													...
													<td > <a href="<?php echo "reporte_pedidos_elaborados1.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol&numero_pedido=$numero_pedido&fecha_pedido=$fecha_pedido&estado_pedido=$estado_pedido&asignado_pedido=$asignado_pedido"; ?>"> <i class="ace-icon fa fa-search-plus bigger-130"></i>		</a>	</td>
												</tr>
		 <?php 
