...
$query = "SELECT id_usuario,email_usuario FROM usuario WHERE usuario.id_usuario='".$id_usuario."'";
...
$query = "SELECT id_usuario,nombre_usuario,nombre_rol,email_usuario FROM usuario INNER JOIN rol ON usuario.id_rol=rol.id_rol WHERE usuario.id_usuario='".$cedula."' AND usuario.password_usuario='".$password."'";
