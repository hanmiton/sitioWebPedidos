...
<script type="text/javascript">
				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="administrar_ayudantes.php<?php echo "?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol"; ?>">Ayudantes</a>
							</li>
							
							<li class="active">Mostrar Ayudantes</li>
		  ...
		  $query = "SELECT id_ayudante,nombre_ayudante,direccion_ayudante,telefono_ayudante,disponible_ayudante  FROM ayudante";
...
while ($line= mysql_fetch_array($result)) {
 ?>
												...
												<tr>
													...
													<td>
														<a href="#">   <?php  $id_ayudante=$line['id_ayudante'];echo $line['id_ayudante'];?></a>													</td>
													<td> <?php echo $line['nombre_ayudante']?></td>
													<td class="hidden-480"><?php echo $line['direccion_ayudante']?></td>
													<td><?php echo $line['telefono_ayudante']?></td>

													<td class="hidden-480">
														<?php echo $line['disponible_ayudante']?>											</td>

													<td>
													<a href="<?php echo "ad_ayudantes.php?id_usuario=$id_usuario&nombre_usuario=$nombre_usuario&nombre_rol=$nombre_rol&text_cedula=$id_ayudante&bt_opcion=Buscar"; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																			<span class="green">
